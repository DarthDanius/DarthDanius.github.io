...
// create html forms for buttons
  ...
  function setBtnForm($_buttons, inputs){// data-action="getform-[name, phone, email]" | return attributes = ['name', 'phone', 'email']
    ...
    function createForm(el, attributes) {
      const action = `${pathFromLibs}/mail.php`;
      ...
      $_submit.click((e) => {
        ...
        if ( validator.validate() ) {
          ...
          $_form_wrap.html(`<div class="form__wrap"><img src="${pathFromImg}/ajax-loader.svg"></div>`);
          let options =  {
            method: 'POST',
  ...
  const inputs = {
    name: {
      ...
      icon: $(`<svg class="form__icon form__icon_name" viewBox="0 0 96 98" aria-hidden="true" focusable="false"><use xlink:href="#icon-user"></use></svg>`),
    ...
    email: {
      ...
      icon: $(`<svg class="form__icon form__icon_mail" viewBox="0 0 63 41" aria-hidden="true" focusable="false"><use xlink:href="#icon-mail"></use></svg>`),
    ...
    phone: {
      ...
      icon: $(`<svg class="form__icon form__icon_phone" viewBox="0 0 43 43" aria-hidden="true" focusable="false"><use xlink:href="#icon-phone"></use></svg>`),
